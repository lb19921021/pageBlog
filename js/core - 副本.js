...
$(document).ready(function() {
    ...
    var user = 'lb19921021';
    blogListURL = 'https://api.github.com/repos/' + user + '/blogio/contents/blogs';
    issuesList = 'https://api.github.com/repos/' + user + '/blogio/issues';
    issuesHTML = 'https://github.com/' + user + '/blogio/issues'
    readmeURL = 'https://raw.githubusercontent.com/' + user + '/blogio/master/About Me.md';


    //$("#header").text(user + "'s Blog");
	    $("#header").text("LiangBin's Blog");
	...
	function getul(name){	
		var l=$('<li class="dropdown"></li>');
		var ul=$(' <ul class="dropdown-menu"></ul>');
		l.append('<a href="#" class="dropdown-toggle" data-toggle="dropdown">'+name+'<b class="caret"></b> </a>');
		l.append(ul);
	$.getJSON(blogListURL+"/"+name, function(json) {
        for (var i = 0; i < json.length; i++) {
